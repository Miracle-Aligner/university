...
public class HelicopterAnimation implements ActionListener, KeyListener {
    ...
    public HelicopterAnimation(TransformGroup helicopter) {
        this.helicopter = helicopter;
        this.helicopter.getTransform(this.transform3D);
    ...
    private void Move() {
        ...
        helicopter.setTransform(transform3D);
    }
